...
11. On the “Install SQL” page, replace the command “*sudo apt-get install mysql-server php-mysql -y*” with “*sudo apt install mariadb-server mariadb-client php-mysql -y*”. In a recent version of Raspbian MySQL is replaced with MariaDB which is fork of the MySQL. 
